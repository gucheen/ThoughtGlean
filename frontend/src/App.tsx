...
function DateGroup({ dateKey, notes, noteByID, continuationCounts, query, searchHints, keyboardSelectedID, view, open, update, restore }: { dateKey: string; notes: Note[]; noteByID: Map<string, Note>; continuationCounts: Map<string, number>; query: string; searchHints: Map<string, string>; keyboardSelectedID?: string; view: View; open: (noteID: string) => void; update: (note: Note, patch: Partial<Note>) => Promise<void>; restore: (note: Note) => Promise<void> }) {
